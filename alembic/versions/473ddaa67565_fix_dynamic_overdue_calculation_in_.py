"""fix dynamic overdue calculation in ledger_summary

Revision ID: 473ddaa67565
Revises: 51a2c3b4d5e6
Create Date: 2026-04-16 10:39:24.828036
...
revision: str = '473ddaa67565'
down_revision: Union[str, None] = '51a2c3b4d5e6'
...
def upgrade() -> None:
    ...
    # Recreate view with dynamic overdue calculation based on due_date
    op.execute("""
...
def downgrade() -> None:
    # Not needed for simple view replacement during forward dev loop
    pass